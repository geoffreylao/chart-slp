...
function actionsBarChartData(
  ...
  for (let i = 0; i < items.length; i++) {
    if (items[i][1] !== 0) {
      orderedActionsArr.push({
        label: charDict[items[i][0]]
          .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
          .replace('.png', ''),
  ...
  for (let i = 0; i < oppitems.length; i++) {
    if (oppitems[i][1] !== 0) {
      orderedActionsArr.push({
        label: charDict[oppitems[i][0]]
          .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
          .replace('.png', ` (${opponent})`),
...
function movesBarChartData(
  ...
  if (radio === 'Neutral Wins') {
    for (let i = 0; i < items.length; i++) {
      if (items[i][1] !== 0) {
        downb =
          items[i][0] === '12' || items[i][0] === '21' || items[i][0] === '6'
            ? neutralArr[items[i][0]][21] + neutralArr[items[i][0]][1]
            : neutralArr[items[i][0]][21];
        movesArr.push({
          label: charDict[items[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ''),
          data: [
            neutralArr[items[i][0]][2] +
              neutralArr[items[i][0]][3] +
              neutralArr[items[i][0]][4] +
              neutralArr[items[i][0]][5],
            neutralArr[items[i][0]][6],
            neutralArr[items[i][0]][7],
            neutralArr[items[i][0]][8],
            neutralArr[items[i][0]][9],
            neutralArr[items[i][0]][10],
            neutralArr[items[i][0]][11],
            neutralArr[items[i][0]][12],
            neutralArr[items[i][0]][13],
            neutralArr[items[i][0]][14],
            neutralArr[items[i][0]][15],
            neutralArr[items[i][0]][16],
            neutralArr[items[i][0]][17],
            neutralArr[items[i][0]][18],
            neutralArr[items[i][0]][19],
            neutralArr[items[i][0]][20],
            downb,
            neutralArr[items[i][0]][50] + neutralArr[items[i][0]][51],
            neutralArr[items[i][0]][52] +
              neutralArr[items[i][0]][53] +
              neutralArr[items[i][0]][54] +
              neutralArr[items[i][0]][55] +
              neutralArr[items[i][0]][56],
    ...
    for (let i = 0; i < oppitems.length; i++) {
      if (oppitems[i][1] !== 0) {
        downb =
          oppitems[i][0] === '12'
            ? oppNeutralArr[oppitems[i][0]][21] +
              oppNeutralArr[oppitems[i][0]][1]
            : oppNeutralArr[oppitems[i][0]][21];
        movesArr.push({
          label: charDict[oppitems[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ` (${opponent})`),
          data: [
            oppNeutralArr[oppitems[i][0]][2] +
              oppNeutralArr[oppitems[i][0]][3] +
              oppNeutralArr[oppitems[i][0]][4] +
              oppNeutralArr[oppitems[i][0]][5],
            oppNeutralArr[oppitems[i][0]][6],
            oppNeutralArr[oppitems[i][0]][7],
            oppNeutralArr[oppitems[i][0]][8],
            oppNeutralArr[oppitems[i][0]][9],
            oppNeutralArr[oppitems[i][0]][10],
            oppNeutralArr[oppitems[i][0]][11],
            oppNeutralArr[oppitems[i][0]][12],
            oppNeutralArr[oppitems[i][0]][13],
            oppNeutralArr[oppitems[i][0]][14],
            oppNeutralArr[oppitems[i][0]][15],
            oppNeutralArr[oppitems[i][0]][16],
            oppNeutralArr[oppitems[i][0]][17],
            oppNeutralArr[oppitems[i][0]][18],
            oppNeutralArr[oppitems[i][0]][19],
            oppNeutralArr[oppitems[i][0]][20],
            downb,
            oppNeutralArr[oppitems[i][0]][50] +
              oppNeutralArr[oppitems[i][0]][51],
            oppNeutralArr[oppitems[i][0]][52] +
              oppNeutralArr[oppitems[i][0]][53] +
              oppNeutralArr[oppitems[i][0]][54] +
              oppNeutralArr[oppitems[i][0]][55] +
              oppNeutralArr[oppitems[i][0]][56],
            oppNeutralArr[oppitems[i][0]][61] +
              oppNeutralArr[oppitems[i][0]][62],
          ],
          backgroundColor: charbackgroundColorDict[oppitems[i][0]],
          borderColor: charborderColorDict[oppitems[i][0]],
          borderWidth: 1,
  ...
  if (radio === 'Counter Hits') {
    for (let i = 0; i < items.length; i++) {
      if (items[i][1] !== 0) {
        downb =
          items[i][0] === '12' || items[i][0] === '21' || items[i][0] === '6'
            ? counterArr[items[i][0]][21] + counterArr[items[i][0]][1]
            : counterArr[items[i][0]][21];
        movesArr.push({
          label: charDict[items[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ''),
          data: [
            counterArr[items[i][0]][2] +
              counterArr[items[i][0]][3] +
              counterArr[items[i][0]][4] +
              counterArr[items[i][0]][5],
            counterArr[items[i][0]][6],
            counterArr[items[i][0]][7],
            counterArr[items[i][0]][8],
            counterArr[items[i][0]][9],
            counterArr[items[i][0]][10],
            counterArr[items[i][0]][11],
            counterArr[items[i][0]][12],
            counterArr[items[i][0]][13],
            counterArr[items[i][0]][14],
            counterArr[items[i][0]][15],
            counterArr[items[i][0]][16],
            counterArr[items[i][0]][17],
            counterArr[items[i][0]][18],
            counterArr[items[i][0]][19],
            counterArr[items[i][0]][20],
            downb,
            counterArr[items[i][0]][50] + counterArr[items[i][0]][51],
            counterArr[items[i][0]][52] +
              counterArr[items[i][0]][53] +
              counterArr[items[i][0]][54] +
              counterArr[items[i][0]][55] +
              counterArr[items[i][0]][56],
    ...
    for (let i = 0; i < oppitems.length; i++) {
      if (oppitems[i][1] !== 0) {
        downb =
          oppitems[i][0] === '12'
            ? oppCounterArr[oppitems[i][0]][21] +
              oppCounterArr[oppitems[i][0]][1]
            : oppCounterArr[oppitems[i][0]][21];
        movesArr.push({
          label: charDict[oppitems[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ` (${opponent})`),
          data: [
            oppCounterArr[oppitems[i][0]][2] +
              oppCounterArr[oppitems[i][0]][3] +
              oppCounterArr[oppitems[i][0]][4] +
              oppCounterArr[oppitems[i][0]][5],
            oppCounterArr[oppitems[i][0]][6],
            oppCounterArr[oppitems[i][0]][7],
            oppCounterArr[oppitems[i][0]][8],
            oppCounterArr[oppitems[i][0]][9],
            oppCounterArr[oppitems[i][0]][10],
            oppCounterArr[oppitems[i][0]][11],
            oppCounterArr[oppitems[i][0]][12],
            oppCounterArr[oppitems[i][0]][13],
            oppCounterArr[oppitems[i][0]][14],
            oppCounterArr[oppitems[i][0]][15],
            oppCounterArr[oppitems[i][0]][16],
            oppCounterArr[oppitems[i][0]][17],
            oppCounterArr[oppitems[i][0]][18],
            oppCounterArr[oppitems[i][0]][19],
            oppCounterArr[oppitems[i][0]][20],
            downb,
            oppCounterArr[oppitems[i][0]][50] +
              oppCounterArr[oppitems[i][0]][51],
            oppCounterArr[oppitems[i][0]][52] +
              oppCounterArr[oppitems[i][0]][53] +
              oppCounterArr[oppitems[i][0]][54] +
              oppCounterArr[oppitems[i][0]][55] +
              oppCounterArr[oppitems[i][0]][56],
            oppCounterArr[oppitems[i][0]][61] +
              oppCounterArr[oppitems[i][0]][62],
          ],
          backgroundColor: charbackgroundColorDict[oppitems[i][0]],
          borderColor: charborderColorDict[oppitems[i][0]],
          borderWidth: 1,
  ...
  if (radio === 'Trades') {
    for (let i = 0; i < items.length; i++) {
      if (items[i][1] !== 0) {
        downb =
          items[i][0] === '12' || items[i][0] === '21' || items[i][0] === '6'
            ? tradeArr[items[i][0]][21] + tradeArr[items[i][0]][1]
            : tradeArr[items[i][0]][21];
        movesArr.push({
          label: charDict[items[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ''),
          data: [
            tradeArr[items[i][0]][2] +
              tradeArr[items[i][0]][3] +
              tradeArr[items[i][0]][4] +
              tradeArr[items[i][0]][5],
            tradeArr[items[i][0]][6],
            tradeArr[items[i][0]][7],
            tradeArr[items[i][0]][8],
            tradeArr[items[i][0]][9],
            tradeArr[items[i][0]][10],
            tradeArr[items[i][0]][11],
            tradeArr[items[i][0]][12],
            tradeArr[items[i][0]][13],
            tradeArr[items[i][0]][14],
            tradeArr[items[i][0]][15],
            tradeArr[items[i][0]][16],
            tradeArr[items[i][0]][17],
            tradeArr[items[i][0]][18],
            tradeArr[items[i][0]][19],
            tradeArr[items[i][0]][20],
            downb,
            tradeArr[items[i][0]][50] + tradeArr[items[i][0]][51],
            tradeArr[items[i][0]][52] +
              tradeArr[items[i][0]][53] +
              tradeArr[items[i][0]][54] +
              tradeArr[items[i][0]][55] +
              tradeArr[items[i][0]][56],
    ...
    for (let i = 0; i < oppitems.length; i++) {
      if (oppitems[i][1] !== 0) {
        downb =
          oppitems[i][0] === '12'
            ? oppTradeArr[oppitems[i][0]][21] + oppTradeArr[oppitems[i][0]][1]
            : oppTradeArr[oppitems[i][0]][21];
        movesArr.push({
          label: charDict[oppitems[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ` (${opponent})`),
          data: [
            oppTradeArr[oppitems[i][0]][2] +
              oppTradeArr[oppitems[i][0]][3] +
              oppTradeArr[oppitems[i][0]][4] +
              oppTradeArr[oppitems[i][0]][5],
            oppTradeArr[oppitems[i][0]][6],
            oppTradeArr[oppitems[i][0]][7],
            oppTradeArr[oppitems[i][0]][8],
            oppTradeArr[oppitems[i][0]][9],
            oppTradeArr[oppitems[i][0]][10],
            oppTradeArr[oppitems[i][0]][11],
            oppTradeArr[oppitems[i][0]][12],
            oppTradeArr[oppitems[i][0]][13],
            oppTradeArr[oppitems[i][0]][14],
            oppTradeArr[oppitems[i][0]][15],
            oppTradeArr[oppitems[i][0]][16],
            oppTradeArr[oppitems[i][0]][17],
            oppTradeArr[oppitems[i][0]][18],
            oppTradeArr[oppitems[i][0]][19],
            oppTradeArr[oppitems[i][0]][20],
            downb,
            oppTradeArr[oppitems[i][0]][50] + oppTradeArr[oppitems[i][0]][51],
            oppTradeArr[oppitems[i][0]][52] +
              oppTradeArr[oppitems[i][0]][53] +
              oppTradeArr[oppitems[i][0]][54] +
              oppTradeArr[oppitems[i][0]][55] +
              oppTradeArr[oppitems[i][0]][56],
  ...
  if (radio === 'Kill Moves') {
    for (let i = 0; i < items.length; i++) {
      if (items[i][1] !== 0) {
        downb =
          items[i][0] === '12' || items[i][0] === '21' || items[i][0] === '6'
            ? killsArr[items[i][0]][21] + killsArr[items[i][0]][1]
            : killsArr[items[i][0]][21];
        movesArr.push({
          label: charDict[items[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ''),
          data: [
            killsArr[items[i][0]][2] +
              killsArr[items[i][0]][3] +
              killsArr[items[i][0]][4] +
              killsArr[items[i][0]][5],
            killsArr[items[i][0]][6],
            killsArr[items[i][0]][7],
            killsArr[items[i][0]][8],
            killsArr[items[i][0]][9],
            killsArr[items[i][0]][10],
            killsArr[items[i][0]][11],
            killsArr[items[i][0]][12],
            killsArr[items[i][0]][13],
            killsArr[items[i][0]][14],
            killsArr[items[i][0]][15],
            killsArr[items[i][0]][16],
            killsArr[items[i][0]][17],
            killsArr[items[i][0]][18],
            killsArr[items[i][0]][19],
            killsArr[items[i][0]][20],
            downb,
            killsArr[items[i][0]][50] + killsArr[items[i][0]][51],
            killsArr[items[i][0]][52] +
              killsArr[items[i][0]][53] +
              killsArr[items[i][0]][54] +
              killsArr[items[i][0]][55] +
              killsArr[items[i][0]][56],
    ...
    for (let i = 0; i < oppitems.length; i++) {
      if (oppitems[i][1] !== 0) {
        downb =
          oppitems[i][0] === '12'
            ? oppKillsArr[oppitems[i][0]][21] + oppKillsArr[oppitems[i][0]][1]
            : oppKillsArr[oppitems[i][0]][21];
        movesArr.push({
          label: charDict[oppitems[i][0]]
            .substring(charDict[items[i][0]].lastIndexOf('/') + 1)
            .replace('.png', ` (${opponent})`),
          data: [
            oppKillsArr[oppitems[i][0]][2] +
              oppKillsArr[oppitems[i][0]][3] +
              oppKillsArr[oppitems[i][0]][4] +
              oppKillsArr[oppitems[i][0]][5],
            oppKillsArr[oppitems[i][0]][6],
            oppKillsArr[oppitems[i][0]][7],
            oppKillsArr[oppitems[i][0]][8],
            oppKillsArr[oppitems[i][0]][9],
            oppKillsArr[oppitems[i][0]][10],
            oppKillsArr[oppitems[i][0]][11],
            oppKillsArr[oppitems[i][0]][12],
            oppKillsArr[oppitems[i][0]][13],
            oppKillsArr[oppitems[i][0]][14],
            oppKillsArr[oppitems[i][0]][15],
            oppKillsArr[oppitems[i][0]][16],
            oppKillsArr[oppitems[i][0]][17],
            oppKillsArr[oppitems[i][0]][18],
            oppKillsArr[oppitems[i][0]][19],
            oppKillsArr[oppitems[i][0]][20],
            downb,
            oppKillsArr[oppitems[i][0]][50] + oppKillsArr[oppitems[i][0]][51],
            oppKillsArr[oppitems[i][0]][52] +
              oppKillsArr[oppitems[i][0]][53] +
              oppKillsArr[oppitems[i][0]][54] +
              oppKillsArr[oppitems[i][0]][55] +
              oppKillsArr[oppitems[i][0]][56],
...
function fourStatBarChartComponent(
  charUsage,
  charStats,
  oppCharUsage,
  oppCharStats,
...
function createSuccessWhiffBarChart(
  success,
  whiff,
  title,
  successLabel,
...
export default class MatchStats extends Component {
  ...
  searchCode() {
    let mycode = this.searchCodeVal.current.value
      .replace('#', '-')
      .toUpperCase();
    let myoppcode = this.oppCodeVal.current.value
      .replace('#', '-')
      .toUpperCase();
      ...
      if (statsLoaded === 'loaded') {
          ...
          <Container fluid>
            ...
            <div className='row'>
              <div className='col-lg-4 sumCol'>
                <div id='imgContainer'>
                  ...
                  <img
                    src={`char_portraits/${myStats.main}/${myStats.mainColor}.png`}
                    width='272'
                    height='376'
                    alt=''
                  />
                  <img src='cssp1.png' width='272' height='376' alt='' />
                  <p id='tagText'>{myStats.code}</p>
                </div>
              </div>
              <div className='col-lg-4 sumCol'>
                <Card id='sumCard'>
                  <p>
                    ...
                    <br />
                    {myStats.totalTime} time played (h:m:s:f)
                    <br />
                    <br />
              ...
              <div className='col-lg-4 sumCol'>
                <div className='chartDiv'>
                  <Donut
                    labels={[
                      myStats.totalLosses + ' Loss',
                      myStats.totalWins + ' Wins',
                    ]}
                    data={[myStats.totalLosses, myStats.totalWins]}
                    title='Winrate'
                    percentage={Math.round(
                      (myStats.totalWins /
                        (myStats.totalLosses + myStats.totalWins)) *
                        100
                    )}
                    player={myStats.code}
            ...
            <div className='row'>
              <div className='col-md-3 openingCols'>
                <div className='chartDiv'>
                  <Donut
                    ...
                    percentage={Math.round(
                      (myStats.neutralWins /
                        (myStats.oppNeutralWins + myStats.neutralWins)) *
                        100
                    )}
                    player={myStats.code}
                    opponent={textOppCode}
              ...
              <div className='col-md-3 openingCols'>
                <div className='chartDiv'>
                  <Donut
                    ...
                    percentage={Math.round(
                      (myStats.counterHits /
                        (myStats.oppCounterHits + myStats.counterHits)) *
                        100
                    )}
                    player={myStats.code}
                    opponent={textOppCode}
              ...
              <div className='col-md-3 openingCols'>
                <div className='chartDiv'>
                  <Donut
                    labels={[
                      myStats.oppBeneficialTrades,
                      myStats.beneficialTrades,
                    ]}
                    data={[
                      myStats.oppBeneficialTrades,
                      myStats.beneficialTrades,
              ...
              <div className='col-md-3 openingCols'>
                <div className='chartDiv'>
                  <Donut
                    ...
                    percentage={Math.round(
                      (myStats.firstBloods /
                        (myStats.oppFirstBloods + myStats.firstBloods)) *
                        100
                    )}
                    player={myStats.code}
                    opponent={textOppCode}
              ...
              <div className='col-sm-3 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.openingsPerKO.toFixed(2),
                      myStats.oppOpeningsPerKO.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-3 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.avgDamagePerOpening,
                      myStats.oppAvgDamagePerOpening,
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-3 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.bestPunish.toFixed(2),
                      myStats.oppBestPunish.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-3 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    label='Lowest % Kill'
                    data={[
                      myStats.lowestKill.toFixed(2),
                      myStats.oppLowestKill.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-3 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    label='Highest % Kill'
                    data={[
                      myStats.highestKill.toFixed(2),
                      myStats.oppHighestKill.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-4 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.avgStocksTaken.toFixed(2),
                      myStats.oppAvgStocksTaken.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-4 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.avgStockDifferential.toFixed(2),
                      myStats.oppAvgStockDifferential.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-4 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    ...
                    data={[
                      myStats.inputsPM.toFixed(2),
                      myStats.oppIPM.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-sm-4 twoBar'>
                <div className='chartDiv'>
                  <VerticalBarChart
                    label='Digital IPM'
                    data={[
                      myStats.digitalIPM.toFixed(2),
                      myStats.oppDigitalIPM.toFixed(2),
                    ]}
                    player={myStats.code}
                    opponent={textOppCode}
                  />
              ...
              <div className='col-md vertbigbar'>
                <div onChange={this.handleInputChange} id='radiobuttons'>
                  <input
                    type='radio'
                    value='Neutral Wins'
                    checked={this.state.radio === 'Neutral Wins'}
                    name='move'
                  />{' '}
                  Neutral Wins &nbsp;
                  <input
                    type='radio'
                    value='Counter Hits'
                    checked={this.state.radio === 'Counter Hits'}
                    name='move'
                  />{' '}
                  Counter Hits &nbsp;
                  <input
                    type='radio'
                    value='Trades'
                    checked={this.state.radio === 'Trades'}
                    name='move'
                  />{' '}
                  Trades &nbsp;
                  <input
                    type='radio'
                    value='Kill Moves'
                    checked={this.state.radio === 'Kill Moves'}
                    name='move'
                  />{' '}
                  Kill Moves &nbsp;
                </div>
            ...
            <div className='row'>
              <div className='col-lg-4 sumCol'>
                <div id='imgContainer2'>
                  ...
                  <img
                    src={`char_portraits/${myStats.rivalsCharId}/${myStats.rivalsColorId}.png`}
                    width='272'
                    height='376'
                    alt=''
                  />
                  <img src='cssp2.png' width='272' height='376' alt='' />
                  <p id='tagText'>{myStats.rival}</p>
                </div>
              </div>
              <div className='col-lg-4 sumCol'>
                <div className='chartDiv'>
                  <Donut
                    labels={[
                      myStats.vsRivalLoss + ' Loss',
                      myStats.vsRivalWin + ' Wins',
                    ]}
                    data={[myStats.vsRivalLoss, myStats.vsRivalWin]}
                    title='Winrate'
                    percentage={Math.round(
                      (myStats.vsRivalWin /
                        (myStats.vsRivalLoss + myStats.vsRivalWin)) *
                        100
                    )}
              ...
              <div className='col-lg-4 sumCol'>
                <Card id='sumCard'>
                  <h6>&nbsp;</h6>
                  <p>
                    Try entering your rival's code as well to see head to head
                    stats!
                  </p>
                </Card>
              </div>
              ...
              <div className='col-md medbar'>
                <div className='chartDiv'>
                  {createQuitoutBarChartCharacterUsage(
                    myStats.quitoutPercent,
                    'Character % of Matches Ending in LRAStart',
                    this.state.charPieCheck
                  )}
                </div>
              </div>
            ...
            <div className='row'>
              <div className='col-md medbar'>
                <div className='chartDiv'>
                  {createQuitoutBarChartCharacterUsage(
                    myStats.quitoutOppPercent,
                    `${textOppCode} Character % of Matches Ending in LRAStart`,
                    this.state.charPieCheck
                  )}
                </div>
              </div>
        ...
        return (
          <div>
            <div id='outer'>
              <div id='inner'>
                <ReactSpinner type='border' color='secondary' size='5' />
              </div>
            </div>
            <div className='noMatches'>
              <p>
                Taking a long time to load your stats? Try further filtering
                your data such as only entering your main in Your Characters
              </p>
            </div>
            <hr></hr>
          </div>
        ...
        return (
          <div className='noMatches'>
            <p>
              No matches found! Please head to <a href={'/add'}>UPLOAD GAMES</a>{' '}
              to learn how to start uploading your games
            </p>
          </div>
        );
      }
    ...
    return (
      <div className='container mt-3'>
        <div className='list row'>
          ...
          <div className='col-md-12'>{renderStats()}</div>
          <div className='col-md-12'>
